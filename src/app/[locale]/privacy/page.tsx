...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy | blockbreaker.im',
    description: 'blockbreaker.im privacy policy',
    keywords: t("keywords"),
    icons: [
      {
        rel: 'icon',
                ...
                <div className="flex flex-col gap-y-10">
                  <div className="flex min-w-full flex-col items-start gap-y-6">
                    <div className="flex flex-col items-start gap-y-3">
                      ...
                      <p className="text-sm">Welcome to <a href="https://blockbreaker.im" className="font-bold underline text-blue-600">https://blockbreaker.im</a>. This privacy policy outlines the types of information we collect, how we use it, and the steps we take to ensure your personal information is handled appropriately.</p>
                    </div>
                    <div className="flex flex-col items-start gap-y-3">
                    ...
                    <div className="flex flex-col items-start gap-y-3">
                      ...
                      <p className="text-sm">blockbreaker.im respects your privacy. We do not share your personal data with any third parties, except as necessary to process your orders or comply with legal requirements.</p>
                    </div>
                    <div className="flex flex-col items-start gap-y-3">
                      <p className="text-sm font-bold">Privacy Policy Changes</p>
                      <p className="text-sm">Although most changes are likely to be minor, blockbreaker.im may change its Privacy Policy from time to time, and in blockbreaker.im's sole discretion.
                         blockbreaker.im encourages visitors to frequently check this page for any changes to its Privacy Policy. Your continued use of this site after any change in this Privacy Policy 
